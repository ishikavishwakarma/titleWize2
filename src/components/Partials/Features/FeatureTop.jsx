...
const FeatureTop = () => {
  ...
  const transactiones = [
    { date: "2023-02-07", firstParty: "Party A", secondParty: "Party B", nature: "Purchase", reference: "Ref123" },
    { date: "2023-02-08", firstParty: "Party C", secondParty: "Party D", nature: "Sale", reference: "Ref124" },
        ...
        <div className="flex flex-col md:flex-row   bg-[#fafafa]  overflow-hidden">
          ...
          <div className="flex-1 w-full py-5 px-1 sm:px-2 lg:p-5 bg-white">
            ...
            <div className="flex items-center gap-0 h-8  mt-5 mb-4 text-sm ">
              ...
              <div className="pointer w-[34%] lg:w-[30%] pt-0 bg-[#E5E7EB]">
                <div className="text-center justify-center">
            ...
            <div className="flex gap-0 mb-2 pt-3 flex-wrap  pl-2 ">
              {/* <div className="w-full sm:w-fit h-8 sm:h-10 p-1  border rounded-full flex items-center justify-between">
                <button className="px-4 py-1 bg-red-500 text-white rounded-full text-xs sm:text-sm">
                  Brief
                </button>
                <button className="px-4 py-1 text-gray-600 hover:bg-gray-100 rounded-full sm:text-sm text-xs">
                  Timeline
                </button>
                <button className="px-4 py-1 text-gray-600 hover:bg-gray-100 rounded-full sm:text-sm text-xs">
                  Detailed
        ...
        {[
          {
            id: "Brief",
            content: (
              <div className="bg-white rounded-lg scale-95 md:scale-90 lg:scale-95 shadow-sm overflow-auto">
                <table className="w-full text-sm border">
                  <thead>
                    <tr className="border-b bg-gray-100">
                      <th className="p-2 font-semibold text-center text-black">Date</th>
                      <th className="p-2 font-semibold text-center text-black">First Party</th>
                      <th className="p-2 font-semibold text-center text-black">Second Party</th>
                      <th className="p-2 font-semibold text-center text-black">Nature of Transaction</th>
                    </tr>
                  </thead>
                  <tbody>
                    {transactions.map((transaction, index) => (
                      <tr key={index} className={index === transactions.length - 1 ? "border-b-0" : ""}>
                        <td className="p-2 text-start">{transaction.date}</td>
                        <td className="p-2 text-center">{transaction.firstParty}</td>
                        <td className="p-2 text-center">{transaction.secondParty}</td>
                        <td className="p-2 text-center">
                          <div className="flex flex-col text-center">
                            <span>{transaction.nature}</span>
