    ...
    <div className="flex w-full mt-10 lg:mt-20 gap-3 xl:w-[90%] flex-col md:flex-row px-5 lg:px-20 xl:px-28 justify-evenly ">
      ...
      <div className="xl:w-[40%] md:w-[55%] lg:w-[50%] w-full   flex flex-col items-center justify-center ">
        <div className="p-5 border-2  h-full border-black flex flex-col items-center justify-center ">
          <p className="lg:text-[26px] text-xl font-bold ">
      ...
      {/* Right Section */}
      <div className="md:w-[55%] w-full gap-4  flex flex-col md:items-end justify-between">
        {/* Table Section */}
          ...
          <div className="bg-white rounded-lg overflow-hidden">
            <table className="w-full text-left">
              <thead className="bg-gray-100">
                <tr>
                  <th className="lg:px-4 md:px-2 px-4 py-2 text-sm md:text-xs lg:text-sm font-medium text-gray-900">
                    MR Entry
                  </th>
                  <th className="lg:px-4 py-2 text-sm md:text-xs lg:text-sm font-medium text-gray-900">
                    EC Entry
                  </th>
                  <th className="lg:px-4 py-2 text-sm md:text-xs lg:text-sm font-medium text-gray-900">
                    RTC Entry
              ...
              <tbody className="divide-y divide-gray-200">
                <tr>
                  ...
                  <td className="lg:px-4 md:px-2 px-4 py-3 md:py-1 lg:py-3 text-sm md:text-xs lg:text-sm">Present</td>
                  <td className="lg:px-4 md:px-2 px-4 py-3 md:py-1 lg:py-3 text-sm md:text-xs lg:text-sm">Present</td>
                </tr>
                <tr>
                  <td className="lg:px-4 md:px-2 px-4 py-3 md:py-1 lg:py-3 text-sm md:text-xs lg:text-sm">
                    MR H12/
                    <br />
                    2017-18
                  </td>
                  <td className="lg:px-4 md:px-2 px-4 py-3 md:py-1 lg:py-3 text-sm md:text-xs lg:text-sm">Present</td>
                  <td className="lg:px-4 md:px-2 px-4 py-3 text-sm md:text-xs lg:text-sm">Present</td>
                </tr>
                <tr>
                  <td className="lg:px-4 md:px-2 px-4 py-3 md:py-1 lg:py-3 text-sm md:text-xs lg:text-sm">
                    MR H11/
                  ...
                  <td className="lg:px-4 md:px-2 px-4 py-3 md:py-1 lg:py-3 text-sm md:text-xs lg:text-sm text-red-500">Not found</td>
                  <td className="lg:px-4 md:px-2 px-4 py-3 text-sm md:text-xs lg:text-sm">Present</td>
                </tr>
              </tbody>
            </table>
          </div>
          <div className="lg:mt-6 mt-6 md:mt-2 space-y-2">
            ...
            <p className="lg:text-base pt-4 md:pt-1 lg:pt-4 text-sm text-gray-900 leading-relaxed">
        ...
        <div className="w-full xl:w-[80%] lg:w-[85%] lg:mt-4 xl:-0 p-4 lg:p-6 bg-white border-[1.9px] border-gray-800 ">
          ...
          <p className="mt-4 text-sm md:text-sm lg:text-base leading-relaxed text-gray-900">
          ...
          <div ref={ref} className="lg:mt-6 mt-4 p-2 lg:p-6 border-2 border-black rounded-md space-y-4">
            {/* Card 1 */}
            <motion.div
              className="card flex  items-center gap-3 p-4 md:p-2.5 lg:p-4 bg-[#EF363626] rounded-lg border border-[#B02527]"
