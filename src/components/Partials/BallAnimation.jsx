  ...
  return (
    <div className="home bg-white w-[95vw] h-48 xl:mt-10 md:h-[70vh] lg:h-[80vh] xl:h-[vh] xxl:h-[70vh] mt-10 lg:mt-0 flex items-center justify-center  flex-col gap-10">
      <div className=" w-[70vw] relative border-none  z-30 top-0 md:top-8  text-[5vh] font-bold h-full md:h-[16vh] md:w-[65vw] lg:w-[48vw] xl:w-[860px]  flex items-center justify-center text-center ">
        ...
        <div className="absolute hidden md:block md:bottom-[85%] lg:bottom-[65%] xl:bottom-[77%] xxl:bottom-[-50%] lg:right-[94.4%] right-[95%]  w-[7vw] md:w-[8.9vw] xl:w-[7vw] h-[50vh] md:h-[25vh] xl:h-[24vh]">
          {/* Box Borders */}
        ...
        <div className="absolute hidden md:block bottom-[70%] left-[95%] lg:left-[99.6%]  w-[7vw] md:w-[8vw] lg:w-[8.9vw] xl:w-[10.6vw] h-[50vh] md:h-[20vh] xl:h-[19vh]">
          {/* Box Borders */}
        ...
        >
          ...
          {/* Animated Ball */}
          <motion.div
            className="absolute  font-normal w-[5px] h-[5px]  z-20 translate-x-[-60%] translate-y-[60%] bg-red-500 rotate-45"
            initial={{ bottom: "0%", right: "0%" }}
            animate={{
        ...
        <div className="absolute hidden md:block md:top-[85%] lg:top-[72%] xl:top-[77%] md:left-[90%] lg:left-[95%] xl:left-[88.8%]  w-[7vw] md:w-[7vw] lg:w-[8.9vw] xl:w-[8vw] h-[50vh] md:h-[25vh] xl:h-[32vh]">
          {/* Box Borders */}
        ...
        <div className="absolute hidden md:block md:top-[82%] lg:top-[70%] xl:top-[77%]  right-[95%]  w-[7vw] md:w-[7vw] lg:w-[15vw] h-[50vh] md:h-[25vh] lg:h-[20vh]">
          {/* Box Borders */}
          <div className="absolute  w-[1px] z-10 h-full bg-gray-100  right-0"></div>
          <div className="w-full flex">
            <div className="absolute  w-full z-10 h-[1px] bg-gray-100 top-full"></div>
